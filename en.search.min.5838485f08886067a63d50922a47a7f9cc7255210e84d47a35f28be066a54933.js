...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/note-cs/flexsearch.min.js');loadScript('/note-cs/en.search-data.min.b09b00603a1e940ff24bbc043ba0eb80422d3dcdfe3b66718d95ac2a29aecef3.js',function(){input.required=false;search();});}
