...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/note-cs/flexsearch.min.js');loadScript('/note-cs/en.search-data.min.8d8ba03f76b5a21e2be706150655e0e8e8c56e702b33defdb62f2710acf4e2ee.js',function(){input.required=false;search();});}
