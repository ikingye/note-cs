...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/note-cs/flexsearch.min.js');loadScript('/note-cs/en.search-data.min.add8228e0a2791308cf552602f03bfa08eb52fec6da18a020a9419ec173a0516.js',function(){input.required=false;search();});}
