...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/note-cs/flexsearch.min.js');loadScript('/note-cs/en.search-data.min.28f378263ccefccc9f7a367ac6d61012c6046b0951d4acad8717dbb7d01e3d78.js',function(){input.required=false;search();});}
