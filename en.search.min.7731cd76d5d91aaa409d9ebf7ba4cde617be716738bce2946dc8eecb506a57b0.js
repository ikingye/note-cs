...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/note-cs/flexsearch.min.js');loadScript('/note-cs/en.search-data.min.c7d29ef1babdcefd91cd8324e375e19683c8537a9a8bfdae65f07c4a20cad7ae.js',function(){input.required=false;search();});}
