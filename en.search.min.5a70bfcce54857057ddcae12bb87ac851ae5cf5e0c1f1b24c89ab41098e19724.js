...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/note-cs/flexsearch.min.js');loadScript('/note-cs/en.search-data.min.25439b67d08814e0283bfc890cd335d01f9ddc0b68d6aa2257eef8b0a5dca04d.js',function(){input.required=false;search();});}
