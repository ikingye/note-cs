...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/note-cs/flexsearch.min.js');loadScript('/note-cs/en.search-data.min.f226988ecd7d8951b09eabe7f0b2d0d55a9d66b8df65a41a52f0e0df63ccf455.js',function(){input.required=false;search();});}
