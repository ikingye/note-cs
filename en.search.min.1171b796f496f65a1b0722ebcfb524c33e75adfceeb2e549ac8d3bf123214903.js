...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/note-cs/flexsearch.min.js');loadScript('/note-cs/en.search-data.min.d78ecd7db4d142877c71678a64e40cbbe5691554895e18067a1b5a27e8b28ea8.js',function(){input.required=false;search();});}
