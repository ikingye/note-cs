...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/note-cs/flexsearch.min.js');loadScript('/note-cs/en.search-data.min.ed25f11c6e35d6aa756e8d7c10da63809de02c9d9c87fdeafe1db25ca31066be.js',function(){input.required=false;search();});}
