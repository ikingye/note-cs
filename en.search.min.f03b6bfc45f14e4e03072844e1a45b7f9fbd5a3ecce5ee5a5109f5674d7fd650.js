...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/note-cs/flexsearch.min.js');loadScript('/note-cs/en.search-data.min.9c80a4c73cd67629d3a8a47dc9215dd95f25ba858ff3e06ca85aff4a585ae36a.js',function(){input.required=false;search();});}
