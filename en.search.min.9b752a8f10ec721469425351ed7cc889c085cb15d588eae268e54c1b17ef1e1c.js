...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/note-cs/flexsearch.min.js');loadScript('/note-cs/en.search-data.min.3729181415e1fada70d0afb8ed916151d4443d1d6eafd60317cccb13ad33abf5.js',function(){input.required=false;search();});}
