...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/note-cs/flexsearch.min.js');loadScript('/note-cs/en.search-data.min.0f38ef0daf1f16dc0da5f755d641f8462eea6734b2055405052500196480263f.js',function(){input.required=false;search();});}
