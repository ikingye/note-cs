...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/note-cs/flexsearch.min.js');loadScript('/note-cs/en.search-data.min.0d0042c23581f24c9243a22da48a04558fbef8c0827e86d956b56541ee514ea6.js',function(){input.required=false;search();});}
