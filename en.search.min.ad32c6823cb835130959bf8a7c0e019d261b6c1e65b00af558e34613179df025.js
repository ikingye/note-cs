...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/note-cs/flexsearch.min.js');loadScript('/note-cs/en.search-data.min.35db15c5116f999a656bcc937df272112cebc09ddf9ff3393293d9f780c62f86.js',function(){input.required=false;search();});}
