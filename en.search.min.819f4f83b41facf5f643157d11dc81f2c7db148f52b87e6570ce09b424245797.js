...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/note-cs/flexsearch.min.js');loadScript('/note-cs/en.search-data.min.406ef7db9280367bffea6124aa4d1a3b70162881d2cdca9183ce249bf35de2ef.js',function(){input.required=false;search();});}
