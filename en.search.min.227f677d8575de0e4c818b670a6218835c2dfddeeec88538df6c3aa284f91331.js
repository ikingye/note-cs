...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/note-cs/flexsearch.min.js');loadScript('/note-cs/en.search-data.min.717342797317b2782ee5546eb922798df527c3750d0251fd2c7cac2df0bc7086.js',function(){input.required=false;search();});}
