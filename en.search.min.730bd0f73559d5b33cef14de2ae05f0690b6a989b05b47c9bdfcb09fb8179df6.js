...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/note-cs/flexsearch.min.js');loadScript('/note-cs/en.search-data.min.0af1bd6077c4b8bbbe2884e4f5da3e2a4cab61a65e9eaf56c73589cbb0bf470f.js',function(){input.required=false;search();});}
