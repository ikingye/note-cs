...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/note-cs/flexsearch.min.js');loadScript('/note-cs/en.search-data.min.5a42c170d6b3fecbb615354295a063b009303566f611c0add31f268061ffb287.js',function(){input.required=false;search();});}
