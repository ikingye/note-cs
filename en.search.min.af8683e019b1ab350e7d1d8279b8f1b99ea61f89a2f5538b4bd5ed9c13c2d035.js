...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/note-cs/flexsearch.min.js');loadScript('/note-cs/en.search-data.min.5dca5cb19a3f7cfdea71a9eb5419ea1873ccf70ddb72bba1986ada9aba183dfa.js',function(){input.required=false;search();});}
