...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/note-cs/flexsearch.min.js');loadScript('/note-cs/en.search-data.min.50618da5205672ac39a2fff7e3c7b88736abf2731cd533d134ebe95b42138f2e.js',function(){input.required=false;search();});}
