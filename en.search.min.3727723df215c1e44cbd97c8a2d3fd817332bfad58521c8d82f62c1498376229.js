...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/note-cs/flexsearch.min.js');loadScript('/note-cs/en.search-data.min.25a3cbf6ca28f86a68c569628fcdabcf78652e3d2d7e364d82cd4d76e5c51347.js',function(){input.required=false;search();});}
