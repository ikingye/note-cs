...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/note-cs/flexsearch.min.js');loadScript('/note-cs/en.search-data.min.97fb29a9e9adb23e6aa4081c49489fc773fbee835de7917a51c8cfe7d9cd601d.js',function(){input.required=false;search();});}
