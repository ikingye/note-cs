...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/note-cs/flexsearch.min.js');loadScript('/note-cs/en.search-data.min.84ccf05956de5d2e0bc25a7f8d5a8b6a4ed03be0aaa991cb641479bd00ccbb9f.js',function(){input.required=false;search();});}
