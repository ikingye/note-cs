...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/note-cs/flexsearch.min.js');loadScript('/note-cs/en.search-data.min.2066e7dfa3a04cd3958f555c1aec3383c143c2a07ecf055d00efd1e9d694b4c7.js',function(){input.required=false;search();});}
